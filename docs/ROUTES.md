...
Production-ready route shells currently include `/dashboard`, `/search`, `/settings`, `/settings/profile`, `/watchlist/[id]`, `/login`, `/signed-out`, and `/account-removed` in addition to the data-backed app routes already marked ready in `docs/DEVELOPER_REFERENCE.md`.
