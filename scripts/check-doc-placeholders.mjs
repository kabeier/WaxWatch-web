...
const CANONICAL_DOCS = [
  ...
  'docs/DESIGN_GUIDE_INTAKE_CHECKLIST.md',
];

const unresolvedPlaceholderPattern = /<(add\b[^>]*|team\b[^>]*|@\b[^>]*|route-or-file\b[^>]*|temporary\s+ref\b[^>]*|official\s+ref\b[^>]*|notes\b[^>]*|token_or_primitive_name\b[^>]*|new_reference_name_or_link\b[^>]*|deprecated\s+temporary\s+mapping\b[^>]*|n\/a\b[^>]*|route-level\s+canonical\s+mapping\b[^>]*)>/gi;
